...
public class UpdateMachineController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int marqueId = Integer.parseInt(request.getParameter("salleId"));
        int id = Integer.parseInt(request.getParameter("id"));
        try {
            Machine machine  = new Machine(id, reference, dateAchat, prix,salleId);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 try {	
			 	...
			 	if(isLogged) {
			 		...
			 		request.setAttribute("marques", salle);
			 		if(idParameter != null) {
